...
import clients.cli as agent_script
import importlib
...
with st.sidebar:
    try:
        ...
        pass
if LANGUAGE == "SWE":
    st.title("Välkommen till din Hypergene-assistent!")
else:
    st.title("Welcome to your Hypergen assistant!")
...
if LANGUAGE == "SWE":
    user_input = st.chat_input("Fråga någonting ...")
else:
...
if user_input:
    ...
    # Show <Thinking> loader in assistant message
    with st.chat_message("assistant"):
